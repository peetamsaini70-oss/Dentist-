    ...
    <section id="contact" className="py-20 px-4 bg-gray-50">
      <div className="max-w-4xl mx-auto bg-white p-12 rounded-[2rem] shadow-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          ...
          <input {...register("phone")} placeholder="Your Phone Number" className="w-full p-4 border border-gray-200 rounded-xl" />
          {errors.phone && <p className="text-red-500 text-sm">{errors.phone.message as string}</p>}
          <input {...register("address")} placeholder="Your Address" className="w-full p-4 border border-gray-200 rounded-xl" />
