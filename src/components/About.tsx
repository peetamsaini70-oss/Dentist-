...
import clinicInterior from "../assets/images/clinic_interior_1782731989761.jpg";

export const About = () => {
  return (
    <section id="about" className="py-20 px-4">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <img src={clinicInterior} alt="Clinic Interior" className="rounded-[2rem] h-96 w-full object-cover shadow-2xl" />
        <div>
